		...
		else
		{
			...
			if($db->editUser($fields,$user_id))
			{
				...
				if( empty( $settings['panel_name'] ) )
					$subject = get_lang_f('subject',"Black Market Servers");
				else
					$subject = get_lang_f('subject',$settings['panel_name']);
				
				$message = "Hello,<br><br>Your Black Market Servers account has been created and you may now login</a>.<br><br>Username: " .  $users_login . "<br>Please do not reply to this email!<br><br>Play it like you STOLE it!!<br>";
